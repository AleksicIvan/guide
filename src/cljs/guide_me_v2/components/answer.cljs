...
(defn beograd-uknjizba-stana []
  [:div
   ...
   [:p [:b "Do skoro je svaka uknjižba stana funkcionisala na sledeći način:"]]
   [:p "naoružate se čeličnim živcima za ono što sledi nakon isplate cene prodavcu. Do tog trenutnak ste se, ako niste koristili usluge advokata već upoznali sa radom Katastra, odnosno morali ste da vadite list nepokretnosti a i da upisujete hipoteku, ukoliko je nepokretnost kupljena na kredit. Kafka je sigurno imao u vidu ovo mesto kada je pisao svoja dela. Prvi savet, posetiti fotokopirnicu koja je pored ulaza u katastar (ili bilo koju) i napraviti dovoljan broj (bar 2 - 3) kopije sve dokumentacije. Pre nego što se uopšte usuditie na odlazak u katastar proverite desetak puta da li ste sve neophodne fotokopije overili kod beležnika, da li imaju sve neophodne pečate, parafe i potpise. Službenici u katastru će vam uzeti papire i samo formalno proveriti da li su ispunjeni uslovi. Ako nešto nedostaje na samom dokumentu to će vam prolongirati predmet na neodređeno vreme."]
   [:p "Tako pripremljeni sa uredno poređanom dokumentacijom stanite u red i budite strpljivi. Možete komotno poneti upravo neku Kafkinu knjigu da prekratite vreme čekanja. Šalteri su podeljeni po opštinama tako da prvo pogledajte koji je šalter opredeljen za opštinu koja je vama od značaja."]
   [:p "Nakon uspešne predaje papira dobićete broj predmeta. Taj broj treba čuvati kao malo vode na dlanu u pustinji. On vam je sudbinski značajan i preko njega ćete se identifikovati, informisati i na kraju, nadamo se uspešno i upisati u katastarske knjige."]
   [:p "Ceo postupak može da potraje u zavisnosti u kome su stanju vaši papiri kao i javne knjige za predmetnu katastarsku opštinu."]
   [:p "Od značaja je da je vama radi pravne sigurnosti bitan datum predaje zahtev za upis."]
   [:p "Ukoliko se rokovi otegnu, ništa vam ne preostaje do da obiđete spratove katastra i naoružate se sladoledima, koka-kolama, kafama i Medenim srce. Uz osmeh i dobru volju nema tog problema koji nećete rešiti, iako to ne deluje tako u pošetku."]
   [:p "Treba imati u vidu i da su zaposleni u katastru ljudi i da i oni imaju dušu, tako da je uvek preporučljivo prema njima se tako i ophoditi."]
   [:div  "Međutim, " [:a {:href "https://www.paragraf.rs/propisi/zakon-o-postupku-upisa-u-katastar-nepokretnosti-i-vodova.html" :target "_blank"} "novim Zakonom o postupku upisa u katastar nepokretnosti i vodova (Sl. glasnik RS, br. 41/2018 i 95/2018)"] " koji je stupio na snagu 8. juna 2018. godine, pokušano je da se upotrebom novih tehnologije ubrza i olakša proces prometa nepokretnosti. Ubrzavanje procesa upisa u katastar nepokretnosti je bio jedan od razloga za donošenja ovog Zakona."]
   [:p "Neophodni papiri se u postupku upisa u katastar nepokretnosti dostavljaju u formi elektronskog dokumenta, kroz e-šalter. Postupak upisa u katastar nepokretnosti pokreće nadležna služba za katastar nepokretnosti po službenoj dužnosti odmah po prijemu isprave koju joj po službenoj dužnosti preko e-šaltera dostave sudovi, javni beležnici, javni izvršitelji, organi javne uprave i drugi organi i organizacije koji u vršenju javnih ovlašćenja donose odluke koje predstavljaju osnov za upis u katastar nepokretnosti."]
   [:div "Mnogo više detalja (uz dosta opravdane pravne terminologije) o novom postupku možete pronaći " [:a {:href "https://zuniclaw.com/e-katastar-nepokretnosti/" :target "_blank"} "ovde."]]
   [:div "Na kraju, " [:a {:href "http://www.rgz.gov.rs/kontakt/info-centar/ezakazivanje" :target "_blank"} "evo "] " linka za zakazivanje sastanaka u katastru. Ovo ne funkcioniše sjajno. Dešava se da nema termina ili da sistem greši prilikom upotrebe, u tim slučajevima vratimo se na koka-kolu, medena srca, kafu i ljubaznost pa onda poseta višim spratovima zgrade katastra."]])
  ...
  ;  [:p "Ako dostavu isprave vrši javni beležnik, on nadležnoj službi za katatstar nepokretnosti dostavlja i poresku prijavu radi utvrđivanja poreza na prenos apsolutnih prava, odnosno poreza na nasleđe i poklon i poresku prijavu radi utvrđivanja poreza na imovinu. Međutim, obveznik podnošenja tih prijava može odbiti da iste budu dostavljene preko javnog beležnika, u kom slučaju javni beležnik dostavlja belešku koju je sačinio o tome. Služba ih potom prosleđuje poreskom organu, odnosno organu jedinice lokalne samouprave nadležnom za utvrđivanje, naplatu i kontrolu izvornih prihoda jedinice lokalne samouprave."]
...
(defn uzice-uknjizba-stana []
  [:div
   [:p "Republički geodetski zavod Služba za katastar nepokretnosti Užice nalazi se u ulici Jug Bogdanova 1/B."]
   [:div "Svaki postupak u katastru podrazumevao je mnogo strpljenja, gubitak živaca i vremesnku crnu rupu. Međutim, " [:a {:href "https://www.paragraf.rs/propisi/zakon-o-postupku-upisa-u-katastar-nepokretnosti-i-vodova.html" :target "_blank"} "novim Zakonom o postupku upisa u katastar nepokretnosti i vodova (Sl. glasnik RS, br. 41/2018 i 95/2018)"] " koji je stupio na snagu 8. juna 2018. godine, pokušano je da se upotrebom novih tehnologije ubrza i olakša proces prometa nepokretnosti. Ubrzavanje procesa upisa u katastar nepokretnosti je bio jedan od razloga za donošenja ovog Zakona."]
   [:p "Neophodni papiri se u postupku upisa u katastar nepokretnosti dostavljaju u formi elektronskog dokumenta, kroz e-šalter. Postupak upisa u katastar nepokretnosti pokreće nadležna služba za katastar nepokretnosti po službenoj dužnosti odmah po prijemu isprave koju joj po službenoj dužnosti preko e-šaltera dostave sudovi, javni beležnici, javni izvršitelji, organi javne uprave i drugi organi i organizacije koji u vršenju javnih ovlašćenja donose odluke koje predstavljaju osnov za upis u katastar nepokretnosti."]
   [:div "Mnogo više detalja (uz dosta opravdane pravne terminologije) o novom postupku možete pronaći " [:a {:href "https://zuniclaw.com/e-katastar-nepokretnosti/" :target "_blank"} "ovde."]]
   [:div "Na kraju, " [:a {:href "http://www.rgz.gov.rs/kontakt/info-centar/ezakazivanje" :target "_blank"} "evo "] " linka za zakazivanje sastanaka u katastru. Ovo ne funkcioniše sjajno. Dešava se da nema termina ili da sistem greši prilikom upotrebe, u tim slučajevima vratimo se na koka-kolu, medena srca, kafu i ljubaznost pa onda poseta višim spratovima zgrade katastra."]])
...
(defn zajecar-uknjizba-stana []
  [:div
   [:p "Republički geodetski zavod Služba za katastar nepokretnosti Zaječar se nalazi na u ulici Nikole Pašića 91."]
   [:div "Svaki postupak u katastru podrazumevao je mnogo strpljenja, gubitak živaca i vremesnku crnu rupu. Međutim, " [:a {:href "https://www.paragraf.rs/propisi/zakon-o-postupku-upisa-u-katastar-nepokretnosti-i-vodova.html" :target "_blank"} "novim Zakonom o postupku upisa u katastar nepokretnosti i vodova (Sl. glasnik RS, br. 41/2018 i 95/2018)"] " koji je stupio na snagu 8. juna 2018. godine, pokušano je da se upotrebom novih tehnologije ubrza i olakša proces prometa nepokretnosti. Ubrzavanje procesa upisa u katastar nepokretnosti je bio jedan od razloga za donošenja ovog Zakona."]
   [:p "Neophodni papiri se u postupku upisa u katastar nepokretnosti dostavljaju u formi elektronskog dokumenta, kroz e-šalter. Postupak upisa u katastar nepokretnosti pokreće nadležna služba za katastar nepokretnosti po službenoj dužnosti odmah po prijemu isprave koju joj po službenoj dužnosti preko e-šaltera dostave sudovi, javni beležnici, javni izvršitelji, organi javne uprave i drugi organi i organizacije koji u vršenju javnih ovlašćenja donose odluke koje predstavljaju osnov za upis u katastar nepokretnosti."]
   [:div "Mnogo više detalja (uz dosta opravdane pravne terminologije) o novom postupku možete pronaći " [:a {:href "https://zuniclaw.com/e-katastar-nepokretnosti/" :target "_blank"} "ovde."]]
   [:div "Na kraju, " [:a {:href "http://www.rgz.gov.rs/kontakt/info-centar/ezakazivanje" :target "_blank"} "evo "] " linka za zakazivanje sastanaka u katastru. Ovo ne funkcioniše sjajno. Dešava se da nema termina ili da sistem greši prilikom upotrebe, u tim slučajevima vratimo se na koka-kolu, medena srca, kafu i ljubaznost pa onda poseta višim spratovima zgrade katastra."]])
